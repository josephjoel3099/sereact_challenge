...
class Door(Node):
    ...
    def __init__(self) -> None:
        ...
        # Lock to protect door_closed_status from concurrent access
...
def main(args: list[str] | None = None) -> None:
    """Entry point: spin the Door node with a multi-threaded executor."""
    import rclpy
    ...
    # Use MultiThreadedExecutor for concurrent callback handling with thread-safe state
